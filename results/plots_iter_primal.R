...
df_admm_all <- readRDS("D:/MEGA/PhD/2025_Q1_spring/8054/project/results/sweep_summary_df_admm_primal.rds")
df_ama_all <- readRDS("D:/MEGA/PhD/2025_Q1_spring/8054/project/results/sweep_summary_df_ama_primal.rds")
...
P_compare_log <- ggplot(plot_df, aes(x = lambda, y = value, color = curve_type)) +
  ...
  scale_color_manual(
    values = c(
      ...
      "ADMM Iterations" = "#377EB8",
      "AMA Iterations" = "#238B45"
    )
  ) +
  guides(
