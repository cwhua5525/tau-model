...
Pri.init.sweep <- NULL #第一loop沒有 warmstart
Dual.init.sweep <- NULL #第一loop沒有 warmstart
...
for (lambda_val in lambda_list) {
  ...
  # 用上個迴圈的結果作為warm start , primal only
  Pri.init.sweep <- ama_result$U 
  #Dual.init.sweep <- ama_result$Lambda 
